      ...
      <div class="p-4">
        <div class="flex items-start">
          ...
          <div class="ml-3 w-0 flex-1 pt-0.5">
            <p class="text-sm font-medium text-gray-900">We're sorry.</p>
            <p class="mt-1 text-sm text-gray-500">There has been an error on our end. We are working on resolving the issue. You are welcome to contact us at admin@amorebooks.io.</p>
          </div>
