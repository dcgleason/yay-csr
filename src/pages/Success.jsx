      ...
      <div class="p-4">
        <div class="flex items-start">
          ...
          <div class="ml-3 w-0 flex-1 pt-0.5">
            <p class="text-sm font-medium text-gray-900">Thank you!</p>
            <p class="mt-1 text-sm text-gray-500">Your messages have successfully submitted. They will be added to your recipient's gift book.</p>
          </div>
