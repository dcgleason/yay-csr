...
const product = {
  ...
  price: '$20',
  description:
    "You & Yours collects written, positive messages <em>about</em> and <em>for</em> a special person in your life from his or her friends and familiy, publishes those messages in a book, and then sends that book to you so that you can give it to that person. All in 3 weeks.",
            ...
            <div className="mt-16 grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:gap-x-8">
              <div>
                ...
                <p className="mt-8 text-base text-gray-500">
                 1. We provide prompts via an email sent to your gift contributors to facilitate the message-writing process. A prompt may be, for example, "How has Eliza impacted your life for the better?" (if Eliza was recieving the gift). Contributors have two weeks to reply with their responses. 
                </p>
              </div>
              <div>
                <div className="w-full aspect-w-3 aspect-h-2 rounded-lg overflow-hidden">
