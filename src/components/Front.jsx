          ...
          <section aria-labelledby="details-heading">
            <div className="flex flex-col items-center text-center">
              ...
              <p className="mt-3 max-w-3xl text-lg text-gray-600">
                We send an email to your gift contributors with prompts, i.e. questions, about your gift recipient, and then we collect your contributors' responses and compile their responses into a book for you to give to your recipient.
              </p>
            </div>
