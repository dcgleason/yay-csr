...
const product = {
  name: 'Create a book. Spread the love.',
  href: '#',
  price: '$45/book',
  description:
   '',
            ...
            <div className="lg:max-w-lg mb-40 pb-40 lg:self-end">
              ...
              <section aria-labelledby="information-heading" className="mt-4">
                ...
                <div className="mt-4 space-y-6">
                  <p className="text-base text-gray-500"><b>Amore Book</b>,  <em>noun</em>: a book of written messages of love and support <u>about</u> and <u>for</u> a special person in your life from <em>his or her</em> family and friends. <br></br><br></br></p>
                </div>
            ...
            <div className="mt-16 grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:gap-x-8">
              <div>
                ...
                <p className="mt-8 text-base text-gray-500">
                 1. Family, friends, and/or coworkers of the gift recipient (i.e. your contributors) write heartfelt messages from prompts on our <a className="underline font-bold" href="https://amorebooks.io/write">Write</a> page about your book recipient using your unique gift code. Contributors have 7 days to submit their responses. 
                </p>
              </div>
              <div>
                <div className="w-8/12 aspect-w-3 aspect-h-2 rounded-lg overflow-hidden">
                ...
                <p className="mt-8 text-base text-gray-500">
                  2. After one week, responses for your book are compiled and published into a physical book within 2-3 days. The completed "book of love" is sent to you, the gift initiator, for you to give to the intended recipient. 
                </p>
              </div>
            </div>
          </section>
            ...
            <div className="grid grid-cols-1 gap-y-12 sm:grid-cols-2 sm:gap-x-6 lg:grid-cols-4 lg:gap-x-8">
              ...
              {/* Start of occations */}
                ...
                <svg xmlns="http://www.w3.org/2000/svg" className="h-24 w-auto text-[#f8ad9d]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                  ...
                  <p className="mt-3 text-base text-gray-500">Congratulate someone on their accomplishments.</p>
                </div>
                <div>
                <svg xmlns="http://www.w3.org/2000/svg" className="h-24 w-auto text-[#f8ad9d]" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                ...
                <path stroke-linecap="round" stroke-linejoin="round" d="M12 8v13m0-13V6a2 2 0 112 2h-2zm0 0V5.5A2.5 2.5 0 109.5 8H12zm-7 4h14M5 12a2 2 0 110-4h14a2 2 0 110 4M5 12v7a2 2 0 002 2h10a2 2 0 002-2v-7" />
                  ...
                  <p className="mt-3 text-base text-gray-500">Give a the bride (or groom) a gift they can cherrish for years to come.</p>
                </div>
                <div>
                <svg xmlns="http://www.w3.org/2000/svg" className="h-24 w-auto text-[#f8ad9d]" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
