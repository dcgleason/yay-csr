            ...
            <div className="mt-16 grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:gap-x-8">
              <div>
                ...
                <p className="mt-8 text-base text-gray-500">
                 1. Family, friends, and/or coworkers of the gift recipient (i.e. your contributors) write heartfelt messages from prompts on our <a className="underline font-bold" href="https://amorebooks.io/write">Write</a> page about your book recipient. Contributors have 7 days to submit their responses. 
                </p>
              </div>
              <div>
                <div className="w-8/12 aspect-w-3 aspect-h-2 rounded-lg overflow-hidden">
            ...
            <div className="grid grid-cols-1 gap-y-12 sm:grid-cols-2 sm:gap-x-6 lg:grid-cols-4 lg:gap-x-8">
              ...
              {/* Start of occations */}
                ...
                <path stroke-linecap="round" stroke-linejoin="round" d="M12 8v13m0-13V6a2 2 0 112 2h-2zm0 0V5.5A2.5 2.5 0 109.5 8H12zm-7 4h14M5 12a2 2 0 110-4h14a2 2 0 110 4M5 12v7a2 2 0 002 2h10a2 2 0 002-2v-7" />
                  ...
                  <p className="mt-3 text-base text-gray-500">Give a the bride (or groom) a gift they can cherish for years to come.</p>
                </div>
                <div>
                <svg xmlns="http://www.w3.org/2000/svg" className="h-24 w-auto text-[#f8ad9d]" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
