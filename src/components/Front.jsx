        ...
        <div className="max-w-2xl mx-auto px-4 py-24 sm:px-6 sm:py-32 lg:max-w-7xl lg:px-8">
          ...
          <div className="flex flex-col items-center pb-10 text-center">
            ...
            <div className="grid grid-cols-1 gap-y-12 sm:grid-cols-2 sm:gap-x-6 lg:grid-cols-4 lg:gap-x-8">
              ...
              {/* Start of occations */}
                <div>
                <svg xmlns="http://www.w3.org/2000/svg" className="h-24 w-auto text-red-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                ...
                <div>
                <svg xmlns="http://www.w3.org/2000/svg" className="h-24 w-auto text-red-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" className="h-24 w-auto text-red-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                  ...
                  <p className="mt-3 text-base text-gray-500">Send thank you's to a special someone.</p>
                </div>
                <div>
                <svg xmlns="http://www.w3.org/2000/svg" className="h-24 w-auto text-red-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
