            ...
            <div className="lg:max-w-lg mb-40 pb-40 lg:self-end">
              ...
              <section aria-labelledby="information-heading" className="mt-4">
                ...
                <div className="mt-4 space-y-6">
                  <p className="text-base text-gray-500"><b>Bundle</b>,  <em>noun</em>: a book of written messages of love and support collected for a special person in your life from <em>his or her</em> family and friends. <br></br><br></br> Connect over <em>shared love</em> for a friend or family member and get the pleasure of making your loved one's week, month, or year. </p>
                </div>
            ...
            <div className="mt-16 grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:gap-x-8">
              <div>
                ...
                <p className="mt-8 text-base text-gray-500">
                 1. Family, friends, and/or coworkers of your Bundle recipient write heartfelt messages from prompts on our <a className="underline font-bold" href="https://bundle.love/write">Write</a> page about your Bundle recipient (we coordinate this for you). These "contributors" have 7 days to submit their responses. 
                </p>
              </div>
              <div>
                <div className="w-8/12 aspect-w-3 aspect-h-2 rounded-lg overflow-hidden">
                ...
                <p className="mt-8 text-base text-gray-500">
                  2. After one week, written responses for your Bundle are compiled and published into a physical book within 2-3 days. The completed book is sent to you to give to the intended recipient. 
                </p>
              </div>
            </div>
          </section>
