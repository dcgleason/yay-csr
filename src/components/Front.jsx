            ...
            <div className="lg:max-w-lg lg:self-end">
              ...
              <section aria-labelledby="information-heading" className="mt-4">
                ...
                <div className="mt-4 space-y-6">
                  <p className="text-base text-gray-500">Kudos Books collects written, positive messages <em>about </em>and <em>for </em>a person in your life who you want to give kudos to. We publish those messages in a physicial book and send that book to you so that you can give it to that person. All in 3 weeks.</p>
                </div>
